...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: in PersonQueue the person was always being inserted directly into the first index of the Queue. It would remove and reinsert the same person at the front of the queue.
    ...
    // Defect(s) Found: No issues found after implementing
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The logic for the infinite turns was not yet implemented in the 
